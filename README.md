...
A small, opinionated system for turning Markdown and PDF sources (NotebookLM exports,
generic Markdown, or PDFs) into a tightly linked personal wiki, maintained by an LLM
(Claude Code) in an interactive session. The system itself is shareable; the notes
inside it are not.
